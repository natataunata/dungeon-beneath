var L = [
    ...
    "Inépuisable.",
    "INÉPUISABLE : Ce personnage ne s'épuise pas lorsqu'il est déplacé.",
    "Feu de camp",
    ...
    "{kw-counter} : Invoque un {kw-summon:39}.",
    "Gelée Métallique",
    ...
    "Garde Sylvestre",
    "Lorsqu'un allié est invoqué, gagne +2/3 {kw-charge}.",
    "Sorcière à Venin",
    ...
    "Baril Explosif",
    "Limon Diviseur",
    "{kw-death} : Invoque deux {kw-summon:39}.",
    "Smithy Mâchentrave",
    ...
    "{kw-endofround} : Invoque une {kw-summon:45}.",
    "Reine de la Couvée",
    "Scarabée Charognard",
    "{kw-endofround} : Donne à la {kw-summon:61} +2 d'Armure.",
    "Colosse Réanimé",
    "Jumeleur",
    "Roi Mâchentrave",
    "{kw-endofround} : Invoque un {kw-summon:43}.",
    "L'Orbe de Commandement",
    "Les Gobelins ont +1 d'Attaque.",
    "Invisible.",
    "Limon Gargantuesque",
    "{kw-endofround} : Invoque deux {kw-summon:39} et change de colonne.",
    "Limon Fossile",
    "Rejeton de Valac",
    "{kw-endofround} : Invoque un {kw-summon:70}.",
    "Orbe Errant",
    "Cible l'un des ennemis les plus proches dans n'importe quelle colonne.",
    "Simulacre Décapité",
    "{kw-followup} : Se déplace.",
    "Masse d'Orbes",
    "{kw-death} : Invoque trois {kw-summon:70}.",
    "{kw-endofround} : Se déplace.",
    "Croc d'Argent",
    "Simulacre Pourrissant",
    "{kw-death} : Invoque un {kw-summon:71}.",
    "Urne Antique",
    "Reine des Orbes",
    ...
    "Fourré Éveillé",
    "{kw-endofround} : Invoque deux {kw-summon:82}.",
    "Araignée",
    "La Vieille Mégère",
    ...
    "Orbe Progéniteur",
    "{kw-endofround} : Invoque deux {kw-summon:70}.",
    "Simulacre Clypaen",
    ...
    "Le Miroir",
    "{kw-endofround} : Invoque un {kw-summon:74}.",
    "L'Ancien",
    "Lorsqu'une Bête alliée meurt, gagne +1 d'Attaque.",
    "Lycan Alpha",
    "{kw-death} : Invoque deux {kw-summon:80}.",
    "Le Non-Voyant",
    ...
    "{kw-endofround} : Invoque une {kw-summon:106}.",
    "Radiance Menaçante",
    "{kw-endofround} : Invoque deux {kw-summon:109}, puis se déplace.",
    "Radiance Instable",
    ...
    "Terreur Cristalline",
    "{kw-death} : Invoque une {kw-summon:114}.",
    "Terreur",
    ...
    "Désorientant.",
    "Flamme Abyssale",
    "{kw-death} : Donne au {kw-summon:118} +1 d'Attaque.",
    "Gardien des Abysses",
    "{kw-endofround} : Invoque une {kw-summon:117}.",
    "Urne Spirituelle",
    "{kw-death} : Détruit l'{kw-summon:120}.",
    "Esprit de Braise",
    ...
    "Prêtre d'Abaddon",
    "{kw-counter} : Donne à {kw-summon:125} +2 d'Armure.",
    "Prêtresse d'Abaddon",
    "{kw-counter} : Donne à {kw-summon:125} +2 {kw-charge}.",
    "Flamme Primordiale",
    "{kw-endofround} : Inflige 2 dégâts à tous les personnages de cette colonne, puis se déplace.",
    "Rocher",
    "Flamme d'Ombre Inférieure",
    "{kw-death} : Invoque une {kw-summon:131}.",
    "Flamme d'Ombre",
    ...
    "Luxure",
    "Envie",
    "{kw-endofround} : Invoque un {kw-summon:139}.",
    "Globe de Poison",
    ...
    "Avarice",
    "{kw-endofround} : Invoque trois {kw-summon:144}.",
    "Corruption",
    "{kw-endofround} : Invoque deux {kw-summon:146}.",
    "Globe Doré",
    "Gourmandise",
    ...
    "Orobas",
    "Morax",
    "{kw-endofround} : Donne à {kw-summon:150} +5 d'Armure.",
    "Aamon",
    "{kw-endofround} : Donne à {kw-summon:150} +3 {kw-charge}.",
    "Haagenti",
    ...
    "Ombre Flamme-Noire",
    "{kw-endofround} : Invoque deux {kw-summon:168} dans cette colonne.",
    "Ombre Électrique",
    "Ombre Instable",
    ...
    "Tombe agitée",
    "{kw-death} : Invoque un {kw-summon:241}.",
    "Vide golem",
    ...
    "Golem parfait",
    "Golem des arcanes",
    "{kw-death} : Invoque un {kw-summon:171}.",
    "Dragon de l'aube",
    "Géant ancien",
    "Mangeur d'hommes",
    ...
    "La première fois qu'un allié meurt, invoque un {kw-summon:241}.",
    ...
    "Manteau de Disciple",
    "Potion de Loyauté",
    "Transformez un {kw-summon:32} en {kw-summon:33}. Le personnage perd tout son équipement. Consommable.",
    "Lame d'Aamon",
    ...
    "Potion de Midas",
    "Transformez un mage en {kw-summon:31} qui peut être vendue pour 10 pièces d'or aux feux de camp. Le personnage perd tout son équipement. Consommable.",
