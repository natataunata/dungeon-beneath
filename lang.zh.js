var L = [
    ...
    "蓝宝石",
    "虚弱之戒",
    "{kw-startofbattle}：获得 3 金币。 (格里克斯长老, 玛丽安娜)",
    "死亡之戒",
    "{kw-startofbattle}：受到 1 点伤害并获得 3 金币。 (Xandos III, 塔兹金, 埃尔斯贝特)",
    "岁月指环",
    "{kw-startofbattle}：获得 3 金币。 (伊洛爱, 多米尼克·布特鲁)",
    "瘟疫之戒",
    "{kw-startofbattle}：中毒并获得 3 金币。 (锤之托瑞克)",
    "转化药水",
    ...
    "先行者",
    "当这个角色杀死一个敌人时，给所有蜥蜴人盟友+1 {kw-charge}。 精力充沛。",
    "争斗者",
    ...
    "夜神，旧月",
    "{kw-otherunitdies}：{kw-weaken} 一个随机敌人。 精力充沛。",
    "被流放者牛头人",
    ...
    "原始火焰",
    "{kw-followup}：对该行的所有角色造成 2 点伤害。 {kw-endofround}：移动。",
    "次级暗影烈焰",
