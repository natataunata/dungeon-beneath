var L = [
    ...
    "肠卜师",
    "{kw-otherunitdies}：对一个随机敌人造成 {kw-scaling:1} 点伤害。",
    "邪教徒",
    "{kw-otherunitdies}：恢复 {kw-scaling:0} 点生命值。",
    "狂战士",
    ...
    "盔甲匠",
    "{kw-endofround}：给该行上的另一个盟友+{kw-scaling:1} 护甲。",
    "太阳法师",
    "获得双倍的{kw-charge}。",
    "修道士",
    "{kw-followup}：为一个受伤的非英雄盟友恢复 {kw-scaling:0} 点生命值。",
    "玫瑰牧师",
    "{kw-healthisrecovered}：对该行最近的敌人造成 {kw-scaling:0} 点伤害。",
    "装甲骑士",
    "拥有等于其护甲值的额外攻击力。",
    "德鲁伊",
    "{kw-channelmana:0}：召唤两次{kw-summon:6/7/8}。",
    "神圣保护者",
    ...
    "获得护甲后攻击。",
    "神射手",
    "当敌人获得 {kw-poison}时，对他们造成 {kw-scaling:0} 点伤害。",
    "先行者",
    "当这个角色杀死一个敌人时，给所有蜥蜴人盟友+1 {kw-charge}。",
    "闪电使者",
    "当此角色获得 {kw-charge} 时，对随机敌人造成 {kw-scaling:0} 点伤害。",
    "钢铁召唤师",
    "{kw-channelmana:0}：召唤一个 {kw-summon:12/13/14}。",
    "黑暗牧师",
    "当这个角色杀死一个敌人时，获得{kw-shield}。",
    "{kw-channelmana:0}： 获得{kw-shield}。",
    "血统主义者",
    "{kw-endofround}：在该行召唤一个敌人{kw-summon:15}。",
    "屠夫",
    "当这个角色杀死一个敌人时，为一个非英雄的受伤盟友恢复 1 点生命值/受损的盟友恢复 1 点生命值，两次/受损的盟友恢复 1 点生命值，三次。",
    "毒饮者",
    "当一个中毒角色死亡时，恢复 {kw-scaling:0} 点生命值。",
    "圣锤牧师",
    ...
    "饮魂者",
    "{kw-endofround}：如果你有 2 个或更多灵魂，恢复 {kw-scaling:0} 生命值。 最大灵魂 +2。",
    "堕落专家",
    ...
    "元素者",
    "当一个盟友元素被召唤时，获得+1攻击力。",
    "{kw-channelmana:0}：召唤一个 {kw-summon:25}。",
    "皇家队长",
