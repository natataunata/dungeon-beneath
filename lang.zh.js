var L = [
    ...
    "当任何角色死亡时获得 +1 攻击力。",
    "迷途的脚链",
    "{kw-endofround}：召唤一只{kw-summon:45}。",
    "主母",
    "腐尸甲虫",
    "{kw-endofround}：给{kw-summon:61}+2 护甲。",
    "复活的巨像",
    "双子巫师",
    "脚链国王",
    "{kw-endofround}：召唤一个 {kw-summon:43}。",
    "眼魔统领",
    "哥布林 +1 攻击力。",
    "隐形。",
    "巨型史莱姆",
    "{kw-endofround}：召唤两个 {kw-summon:39} 并换行。",
    "固化史莱姆",
    "瓦拉克之子",
    "{kw-endofround}：召唤一个{kw-summon:70}。",
    "游荡眼魔",
    "以该行最近的敌人之一为目标。",
    "无头造物",
    "{kw-followup}：移动。",
    "眼魔集群",
    "{kw-death}：召唤三个{kw-summon:70}。",
    "{kw-endofround}：移动。",
    "银牙",
    "邪恶造物",
    "{kw-death}：召唤一个{kw-summon:71}。",
    "古瓮",
    "眼魔女王",
    "每个盟友 +1 攻击力。",
    "毒液拟态",
    ...
    "觉醒丛林",
    "{kw-endofround}：召唤两个 {kw-summon:82}。",
    "蜘蛛",
    "老妪",
    ...
    "{kw-death}：获得 1 金币。",
    "眼魔始祖",
    "{kw-endofround}：召唤两个{kw-summon:70}。",
    "酷派斯拟态",
    ...
    "镜子",
    "{kw-endofround}：召唤一个{kw-summon:74}。",
    "远古邪神",
    "当一只野兽盟友死亡时，获得+1攻击力。",
    "狼人阿尔法",
    "{kw-death}：召唤两个 {kw-summon:80}。",
    "失明者",
    "以生命值最高的敌人为目标。",
    "毒蝎",
    "骸骨毒蝎",
    ...
    "深渊行者",
    "{kw-endofround}：召唤一个{kw-summon:106}。",
    "凶恶的辉光",
    "{kw-endofround}：召唤两个 {kw-summon:109}，然后移动。",
    "不稳定的辉光",
    ...
    "困惑。",
    "炎魔",
    "{kw-death}：给{kw-summon:118}+1 攻击力。",
    "深渊守护者",
    "{kw-endofround}：召唤一个{kw-summon:117}。",
    "灵瓮",
    "{kw-death}：摧毁{kw-summon:120}。",
    "灰烬之灵",
    ...
    "当友方怪物死亡时，获得+1攻击力。",
    "阿巴顿祭司",
    "{kw-counter}：给{kw-summon:125} +2 护甲。",
    "阿巴顿的女祭司",
    "{kw-counter}：给{kw-summon:125} +2 {kw-charge}。",
    "原始火焰",
    "{kw-endofround}. \\\"唤醒\\\"： 对本道中的所有角色造成 2 次伤害，然后移动。",
    "巨石",
    "次级暗影烈焰",
    "{kw-death}：召唤一个 {kw-summon:131}。",
    "暗影烈焰",
    ...
    "色欲",
    "嫉妒",
    "{kw-endofround}：召唤一个 {kw-summon:139}。",
    "毒球",
    ...
    "将生命值最高的敌人设置为 1 点生命值。",
    "贪婪",
    "{kw-endofround}：召唤三个 {kw-summon:144}。",
    "腐败",
    "{kw-endofround}：召唤两个 {kw-summon:146}。",
    "金球",
    "暴食",
    ...
    "奥罗巴斯",
    "莫拉克斯",
    "{kw-endofround}：给 {kw-summon:150} +5 护甲。",
    "阿蒙",
    "{kw-endofround}：给 {kw-summon:150} +3 {kw-charge}。",
    "哈根提",
    "攻击无视护甲。",
    "大巴廷",
    "{kw-death}：麻痹所有非英雄的敌人。",
    ...
    "黑暗火焰阴影",
    "{kw-endofround}：在该行召唤两个 {kw-summon:168}。",
    "带电阴影",
    "不稳定阴影",
    ...
    "追随者披风",
    "忠诚药水",
    "将{kw-summon:32}转变为忠诚的{kw-summon:32}。角色失去所有装备。消耗品。",
    "阿蒙之刃",
    "{kw-counter}：获得 +1 攻击力。",
    "无间剑",
    "冠军之剑",
    ...
    "安德洛玛留斯之爪",
    "迈达斯药水",
    "将法师变成{kw-summon:31}，可以在营火上以 10 金币的价格出售。角色失去所有装备。消耗品。",
    "强效全能药水",
